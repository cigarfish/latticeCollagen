...
#ifndef SEGMENTBILENETWORKONDPPIV20X_H_
#define SEGMENTBILENETWORKONDPPIV20X_H_
...
class SegmentBileNetworkOnDPPIV20x : public BasePipeline<3>
{
...
public:
    SegmentBileNetworkOnDPPIV20x();
    virtual ~SegmentBileNetworkOnDPPIV20x();
...
//    CScalarVoImageType::SizeType m_holeFilling2NeighborhoodRadius;
//    unsigned int m_holeFilling2MajThreshold;
    ...
    std::string m_saveSuffixes[8];
};

#endif /* SEGMENTBILENETWORKONDPPIV20X_H_ */
