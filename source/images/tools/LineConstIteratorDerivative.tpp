///////////////////////////////////////////////////////////////////////////////////////
//                                                                                   //
//  File Name:  LineConstIteratorDerivative.tpp                                      //
//                                                                                   //
...
#include "LineConstIteratorDerivative.h"
...
template< class TImage > LineConstIteratorDerivative< TImage >::LineConstIteratorDerivative(const ImageType *imagePtr, const IndexType & firstIndex, const IndexType & lastIndex)
{
    unsigned int i;
...
template< class TImage > LineConstIteratorDerivative< TImage > & LineConstIteratorDerivative< TImage >::operator=(const Self & it)
{
...
template< class TImage > void LineConstIteratorDerivative< TImage >::GoToBegin()
{
...
template< class TImage > void LineConstIteratorDerivative< TImage >::operator++()
{
