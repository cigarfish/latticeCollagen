...
/*!
 \brief Constructor
 */
template <class TInputImage,class TOutputImage> BinaryThinningImageFilter3D<TInputImage,TOutputImage>::BinaryThinningImageFilter3D()
{
...
/*!
 \brief Return the thinning Image pointer
 */
template <class TInputImage,class TOutputImage> typename BinaryThinningImageFilter3D<TInputImage,TOutputImage>::OutputImageType*
...
/*!
 \  Prepare data for computation
    Copy the input image to the output image, changing from the input type to the output type.
 */
template <class TInputImage,class TOutputImage> void BinaryThinningImageFilter3D<TInputImage,TOutputImage>::PrepareData(void)
{
...
/*!
 \brief Post processing for computing thinning
 */
template <class TInputImage,class TOutputImage> void BinaryThinningImageFilter3D<TInputImage,TOutputImage>::ComputeThinImage()
{
...
/*!
 \brief  Generate ThinImage
 */
template <class TInputImage,class TOutputImage> void BinaryThinningImageFilter3D<TInputImage,TOutputImage>::GenerateData()
{
...
/*!
 \brief Fill the Euler look-up table (LUT) for later check of the Euler invariance. (see [Lee94])
 */
template <class TInputImage,class TOutputImage> void BinaryThinningImageFilter3D<TInputImage,TOutputImage>::fillEulerLUT(int *LUT)
{
    LUT[1]  =  1;
    LUT[3]  = -1;
    LUT[5]  = -1;
...
/*!
 \brief Check for Euler invariance. (see [Lee94])
 */
template <class TInputImage,class TOutputImage> bool BinaryThinningImageFilter3D<TInputImage,TOutputImage>::isEulerInvariant(NeighborhoodType neighbors, int *LUT)
{
...
/*\
 \brief Check if current point is a Simple Point.
 ...
 */
template <class TInputImage,class TOutputImage> bool BinaryThinningImageFilter3D<TInputImage,TOutputImage>::isSimplePoint(NeighborhoodType neighbors)
{
 ...
 * have been removed.
 */
template <class TInputImage,class TOutputImage> void BinaryThinningImageFilter3D<TInputImage,TOutputImage>::Octree_labeling(int octant, int label, int *cube)
{
...
/*\
 \brief  Print Self
 */
template <class TInputImage,class TOutputImage> void BinaryThinningImageFilter3D<TInputImage,TOutputImage>::PrintSelf(std::ostream& os, Indent indent) const
{
