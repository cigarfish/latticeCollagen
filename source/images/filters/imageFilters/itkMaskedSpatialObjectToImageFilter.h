 ...
 */
template <class TInputSpatialObject, class TOutputImage> class ITK_EXPORT MaskedSpatialObjectToImageFilter : public SpatialObjectToImageFilter<TInputSpatialObject, TOutputImage>
{
public:
  ...
  typedef itk::Image<MaskPixelType, OutputImageType::ImageDimension>    MaskImageType;
...
#include "itkMaskedSpatialObjectToImageFilter.tpp"
