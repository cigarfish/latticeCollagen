...
template< class TInputImage, class TOutputPixelType, class TInputVectorPixelType> AverageOutwardFluxImageFilter<TInputImage, TOutputPixelType, TInputVectorPixelType>::AverageOutwardFluxImageFilter()
{
}
...
template< class TInputImage, class TOutputPixelType, class TInputVectorPixelType> void AverageOutwardFluxImageFilter<TInputImage, TOutputPixelType, TInputVectorPixelType>::GenerateData()
{
    try
    {
...
template< class TInputImage, class TOutputPixelType, class TInputVectorPixelType> void AverageOutwardFluxImageFilter<TInputImage, TOutputPixelType, TInputVectorPixelType>::PrintSelf(std::ostream& os, Indent indent) const
{
