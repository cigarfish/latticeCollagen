...
template< class TInputImage, class TAverageOutwardFluxPixelType, class TOutputPixelType> MedialCurveImageFilter<TInputImage, TAverageOutwardFluxPixelType, TOutputPixelType>::MedialCurveImageFilter()
{
}
...
template< class TInputImage, class TAverageOutwardFluxPixelType, class TOutputPixelType> bool MedialCurveImageFilter<TInputImage, TAverageOutwardFluxPixelType, TOutputPixelType>::IsBoundary(OutputIndexType p )
{
    try
    {
...
template< class TInputImage, class TAverageOutwardFluxPixelType, class TOutputPixelType> bool MedialCurveImageFilter<TInputImage, TAverageOutwardFluxPixelType, TOutputPixelType>::IsIntSimple( OutputIndexType p )
{
    try
    {
...
template< class TInputImage, class TAverageOutwardFluxPixelType, class TOutputPixelType> bool MedialCurveImageFilter<TInputImage, TAverageOutwardFluxPixelType, TOutputPixelType>::IsExtSimple( OutputIndexType p )
{
    try
    {
        // Compute new index of the auxiliar queued image
...
template< class TInputImage, class TAverageOutwardFluxPixelType, class TOutputPixelType> bool MedialCurveImageFilter<TInputImage, TAverageOutwardFluxPixelType, TOutputPixelType>::IsEnd( OutputIndexType p )
{
    try
    {
        typename OutputNeighborhoodIteratorType::RadiusType radius;
...
template< class TInputImage, class TAverageOutwardFluxPixelType, class TOutputPixelType> void MedialCurveImageFilter<TInputImage, TAverageOutwardFluxPixelType, TOutputPixelType>::DistanceToObject()
{
    try
    {
...
template< class TInputImage, class TAverageOutwardFluxPixelType, class TOutputPixelType> void MedialCurveImageFilter<TInputImage, TAverageOutwardFluxPixelType, TOutputPixelType>::GenerateData()
{
    try
    {
...
template< class TInputImage, class TAverageOutwardFluxPixelType, class TOutputPixelType> void MedialCurveImageFilter<TInputImage, TAverageOutwardFluxPixelType, TOutputPixelType>
