...
template< class TInputImage, class TOutputPixelType = float, class TInputVectorPixelType = ::itk::CovariantVector<TOutputPixelType,::itk::GetImageDimension<TInputImage>::ImageDimension> >
class ITK_EXPORT AverageOutwardFluxImageFilter : public ImageToImageFilter<TInputImage, ::itk::Image<TOutputPixelType,::itk::GetImageDimension<TInputImage>::ImageDimension> >
{
public:
    ...
    itkConceptMacro(InputVectorIsReallyAVectorCheck, (Concept::HasValueType<TInputVectorPixelType>));
//    itkConceptMacro(InputVectorIsFloatingPointCheck, (Concept::IsFloatingPoint<TInputVectorPixelType::ValueType>));
//    itkConceptMacro(InputVectorIsSameDimensionInputImageCheck, (Concept::SameDimension<TInputVectorPixelType::SizeType,InputImageDimension>));
    itkConceptMacro(OutputIsFloatingPointCheck, (Concept::IsFloatingPoint<TOutputPixelType>));
...
#include "itkAverageOutwardFluxImageFilter.tpp"
