...
template <class TInputSpatialObject, class TOutputImage> MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::MaskedSpatialObjectToImageFilter()
{
...
template <class TInputSpatialObject, class TOutputImage> void MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::SetInput(const InputSpatialObjectType *input)
{
...
template <class TInputSpatialObject, class TOutputImage> void MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::SetMask(const MaskImageType *mask)
{
    if (mask)
    {
...
template <class TInputSpatialObject, class TOutputImage> const typename MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::InputSpatialObjectType * MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::GetInput(void)
{
...
template <class TInputSpatialObject, class TOutputImage> const typename MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::MaskImageType * MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::GetMask(void)
{
...
/** GenerateData */
template <class TInputSpatialObject, class TOutputImage> void MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::GenerateData(void)
{
...
/** SetupOutputImage */
template <class TInputSpatialObject, class TOutputImage> void MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::SetupOutputImage(void)
{
    ...
    for(unsigned int i=0; i<Superclass::ObjectDimension; i++)
    {
...
/** Generate Mask */
template <class TInputSpatialObject, class TOutputImage> void MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::GenerateMask(void)
{
    ...
    typedef itk::SpatialObjectToImageFilter<TInputSpatialObject, MaskImageType> SpatialObjectToImageFilterType;
    typename SpatialObjectToImageFilterType::Pointer filterConvertMask = SpatialObjectToImageFilterType::New();
    ...
    {
        maskSize[dim] = this->m_Size[dim] / m_MaskResampleFactor;
    ...
    typedef itk::BinaryBallStructuringElement<MaskPixelType, OutputImageType::ImageDimension> BinaryBallElementType;
    BinaryBallElementType kernel;
    kernel.SetRadius(m_MaskDilationSize);
    kernel.CreateStructuringElement();

    //Binary dilate the resampled Mask image
    typedef itk::BinaryDilateImageFilter<MaskImageType, MaskImageType, BinaryBallElementType> BinaryDilateImageFilterType;
    ...
    typedef itk::ResampleImageFilter<MaskImageType, MaskImageType, MaskCoordRep> ResampleFilterType;
    typedef itk::CenteredAffineTransform<MaskCoordRep, OutputImageType::ImageDimension> TransformType;
    typedef itk::NearestNeighborInterpolateImageFunction<MaskImageType, MaskCoordRep> InterpolatorType;
    ...
    double finalMaskOrigin[OutputImageType::ImageDimension];       //Set Origin
...
template <class TInputSpatialObject, class TOutputImage> void MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::GenerateDataUsingMask(void)
{
    ...
    itk::Point<double, Superclass::ObjectDimension> point;
...
template<class TInputSpatialObject, class TOutputImage> void MaskedSpatialObjectToImageFilter<TInputSpatialObject,TOutputImage>::PrintSelf(std::ostream& os, Indent indent) const
{
