///////////////////////////////////////////////////////////////////////////////////////
//                                                                                   //
//  File Name:  vtkPOVExporterWireFrame.cpp                                          //
//                                                                                   //
...
#include "vtkPOVExporterWireFrame.h"
...
vtkStandardNewMacro(vtkPOVExporterWireFrame);
...
//============================================================================
vtkPOVExporterWireFrame::vtkPOVExporterWireFrame()
{
  this->FileName = NULL;
  this->FilePtr = NULL;
  this->Internals = new vtkPOVInternalsWireFrame;
}
...
void vtkPOVExporterWireFrame::WriteData()
{
...
void vtkPOVExporterWireFrame::WriteHeader(vtkRenderer *renderer)
{
...
void vtkPOVExporterWireFrame::WriteCamera(vtkCamera *camera)
{
...
void vtkPOVExporterWireFrame::WriteLight(vtkLight *light)
{
...
void vtkPOVExporterWireFrame::WriteActor(vtkActor *actor)
{
  ...
  /*
  vtkCellArray *lines = polys->GetLines();
  for (vtkIdType i = 0; i < lines->GetNumberOfCells(); i++) 
    {
      vtkDataArray *start = lines->GetCell();
...
void vtkPOVExporterWireFrame::WritePolygons(vtkPolyData *polys, bool scalar_visible)
{
...
void vtkPOVExporterWireFrame::WriteTriangleStrips(
...
void vtkPOVExporterWireFrame::WriteProperty(vtkProperty *property)
{
...
void vtkPOVExporterWireFrame::PrintSelf(ostream& os, vtkIndent indent)
{
